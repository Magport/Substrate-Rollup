...
use rollup_node_executor as node_executor;
use rollup_runtime::{
...
pub fn compact_code_unwrap() -> &'static [u8] {
    rollup_runtime::WASM_BINARY.expect(
...
pub const SPEC_VERSION: u32 = rollup_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = rollup_runtime::VERSION.transaction_version;
