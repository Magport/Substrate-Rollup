...
use rollup_runtime::{constants::currency::*, BalancesCall};
...
use rollup_node_cli as node_cli;
...
fn extrinsic_set_time(now: u64) -> OpaqueExtrinsic {
	rollup_runtime::UncheckedExtrinsic {
		signature: None,
		function: rollup_runtime::RuntimeCall::Timestamp(pallet_timestamp::Call::set { now }),
	}
	.into()
}
